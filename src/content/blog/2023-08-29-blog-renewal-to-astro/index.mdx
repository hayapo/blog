...
### MDX でブログを入稿する (Contents Collections)
...
Astro では<ExternalLink href="https://docs.astro.build/en/guides/content-collections/" title="Astro Content Collections">Contens Collections</ExternalLink>
...
Astro はデフォルトで JS 配信が無いサイトを作ることができるので、ブログのような Contents First なサイトを作るのに向いていると思います。
