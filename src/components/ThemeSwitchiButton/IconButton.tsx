...
interface Props {
  theme: "light" | "dark";
  handleClick: (theme: "light" | "dark") => void;
}

const ICON_SIZE = "1.5rem";

export function IconButton({ theme, handleClick }: Props) {
  const label = theme === "light" ? "Toggle dark mode" : "Toggle dark mode";

  const iconColor =
    theme === "light"
      ? { base: "#FF7A00", _dark: "#FFF" }
      : { base: "#FFF", _dark: "#FF7A00" };
